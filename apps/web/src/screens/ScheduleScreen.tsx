  ...
  return (
    <main className="screen schedule-screen">
      ...
      {favoriteExams.length === 0 ? (
        <section className="empty-state"><span aria-hidden="true">▦</span><h3>아직 저장한 시험이 없어요.</h3><p>관심 시험을 저장하면 다음 접수와 시험일을 여기에 모아드려요.</p><button className="primary-button" type="button" onClick={onFind}>시험 찾으러 가기</button></section>
